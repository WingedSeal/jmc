...
const SidebarNav: React.FC<SidebarNavInterface> = ({ children }) => {
    ...
    return (
        <div className="flex">
            ...
            {isOpen ? (
                <div
                    className="cursor-pointer text-white mt-[80vh] md:mt-8 fixed z-50 ml-[calc(100%-1.75rem)] md:ml-[16.667%] w-7 h-7 bg-tertiary-contrast rounded-tl-lg md:rounded-none md:rounded-tr-lg md:rounded-br-lg flex"
                ...
                <div
                    className="cursor-pointer text-white mt-8 fixed z-50 w-7 h-7 bg-tertiary-contrast rounded-tr-lg rounded-br-lg flex"
