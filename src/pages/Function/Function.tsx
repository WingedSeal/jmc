    ...
    return (
        <section className="min-h-screen bg-secondary-dark flex flex-wrap pt-[14vh] pb-5 md:pt-[15vh] px-4 md:px-11 flex-col items-centers">
            ...
            <div className="text-white text-base md:text-2xl mt-4">
                <p>
                    &emsp;Say goodbye to creating a new file for every single
                    function, introducing Function Defining. This feature allows
                    you to define as many functions as you want in a single
                    file. Any capital letter (which is invalid for mcfunction
                    name) will automatically be turned into lowercase, which
                    means it is not case-sensitive. For example,{" "}
                    <code>deathMessage</code> is the same as{" "}
                ...
                <CodeBlock>
                    ...
                    () {"{"} <br />
                    &emsp;say{" "}
                    <CodeText type="string">"Code example 1"</CodeText>;<br />
                    &emsp;say{" "}
                    <CodeText type="string">"Code example 2"</CodeText>;<br />
                    {"}"}
                    <br />
                    <CodeText type="keyword">function</CodeText>{" "}
                    ...
                    () {"{"} <br />
                    &emsp;say{" "}
                    <CodeText type="string">"Code example 3"</CodeText>;<br />
                    {"}"}
                </CodeBlock>
                <p>
                ...
                <CodeBlock>
                    ...
                    <CodeText type="error">$parameter</CodeText>) {"{"} <br />
                    &emsp;say{" "}
            ...
            <div className="text-white text-base md:text-2xl mt-4">
                <p>
                    &emsp;Instead of using the <code>/function</code> command,
                    you can use parentheses to call a function. JMC will add a
                    namespace for you automatically. Like function defining, the
            ...
            <div className="text-white text-base md:text-2xl mt-4">
                <p>
                    ...
                    things. Why bother creating a whole new function just to run
                    a few commands as an entity? You are allowed to run multiple
                    commands in an execute chain in JMC.
                </p>
                <CodeBlock>
            ...
            <div className="text-white text-base md:text-2xl mt-4">
                <p>
                    &emsp;It simply adds extra layers of directory/namespace to
                    any function/
                    <Link to="/documentation/json-files" className="underline">
                        json
                    </Link>{" "}
                    (Doesn't affect variable) inside it.{" "}
                    <span className="text-warning">
                        {" "}
                        Even though syntax uses the word "class", it is NOT a
                        traditional class.
                    </span>
                </p>
                <CodeBlock>
