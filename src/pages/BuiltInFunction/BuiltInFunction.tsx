    ...
    return (
        <section className="bg-secondary-dark min-h-screen w-screen flex flex-col px-2 md:px-10 pt-[17vh]">
            <Feature
                ...
                keywords="tutorial explaination parameter type help"
            ...
            >
                ...
                />
                <p>
                    Module is actually a part of the function name and bare no
                    special meaning. If you mistype the name, JMC will assume
                    you are calling your own custom function and throw an error
                    saying "Custom function's parameter is not supported."
                </p>
                <p>
                    Unlike JavaScript, JMC actually support named parameter,
                    which mean you can specify which argument it is.
                </p>
                ...
                <CodeBlock>
                    ...
                    <CodeText type="operator">=</CodeText> {"()=>{"}say{" "}
                    <CodeText type="string">"Hello World"</CodeText>;{"}"}
                    <br />
                ...
                <CodeBlock>
                    ...
                    <CodeText type="operator">:</CodeText> Used in condition
                    ...
                    <br />
                    {"}"}
                    <br />- <CodeText type="class">
                        ExecuteExcluded
                    </CodeText>{" "}
                    <CodeText type="operator">:</CodeText> Cannot be used in
                    execute command
                    <br />- <CodeText type="class">LoadOnly</CodeText>{" "}
                    <CodeText type="operator">:</CodeText> Can only be used in
                    load (Can't be used inside any function)
                    ...
                    <CodeText type="operator">:</CodeText> Need to store result
                    into minecraft scoreboard or jmc variable
                    <br />
                    ...
                    <CodeText type="operator">:</CodeText> Normal JMC function
                ...
                <CodeBlock>
                    ...
                    <br />
                    &emsp;&emsp;say{" "}
                    <CodeText type="string">"I'm very cool"</CodeText>;<br />
            ...
            >
                <p>
                    Run commands on positive change of scoreboard and reset the
                    score.
                </p>
                <Command
                    name="Player.onEvent"
            ...
            >
                <p>
                    Run commands as player and at player when joining the World
                    for the first time.
                </p>
                <p className="text-warning">
                    Revoking all advancements will cause this to be called
                    again.
                </p>
                <Command
            ...
            >
                <p>
                    Run commands as player and at player when a player leave a
                    world then join back.
                </p>
                <p className="text-warning">
            ...
            >
                <p>
                    Run onDeath as player and at player's last position when the
                    player die
                </p>
                <p>
                    Run onRespawn as player and at player spawn location when
                    the player respawn
                </p>
                <Command
                    name="Player.die"
            ...
            >
                ...
                <p>
                    onClick can only be used with "carrot_on_a_stick" itemType.
                </p>
                <p>
                    itemId is the unique name of this item so that it can be
                    referenced in other Item function.
                </p>
                <Command
                    name="Item.create"
                    type="LoadOnly"
