        ...
        <section className="min-h-screen bg-[#002029] flex flex-wrap pt-[14vh] md:pt-[15vh] px-2 md:px-10 flex-col items-centers">
            ...
            <div className="flex flex-row flex-wrap justify-evenly mt-4 md:mt-6">
                ...
                <div className="flex flex-col flex-nowrap items-center m-8">
                    ...
                    <a href="https://github.com/WingedSeal/jmc/releases/latest" target="_blank" rel="noreferrer" className="h-16 w-44 md:h-24 md:w-72 bg-[#ffaa00] flex text-[#000000] font-bold text-lg md:text-3xl">
