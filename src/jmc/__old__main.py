...
""", color=Colors.YELLOW)
    ...
    def compile(cls, *args):
        ...
        try:
            ...
            # error_report(error)
            handle_exception(error, is_should_happen=False)
...
def handle_exception(error: Exception, is_should_happen: bool):
    """
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            handle_exception(error, is_should_happen=True)
