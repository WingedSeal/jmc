...
execute if score __if_else__ __variable__ matches 0 run say FALSE
...
scoreboard players set __if_else__ __variable__ 0
execute if entity condition run function TEST:__private__/if_else/0
execute if score __if_else__ __variable__ matches 0 if entity condition2 run say CONDITION2
> VIRTUAL/data/TEST/functions/__private__/if_else/0.mcfunction
say CONDITION1
scoreboard players set __if_else__ __variable__ 1
            """)
