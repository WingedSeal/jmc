...
execute store result score __math__.rng.a __variable__ run get entity @e[limit=1] UUID[1] 1
scoreboard players operation __math__.rng.a __variable__ *= __math__.rng.a __variable__
execute store result score __math__.rng.c __variable__ run get entity @e[limit=1] UUID[2] 1
